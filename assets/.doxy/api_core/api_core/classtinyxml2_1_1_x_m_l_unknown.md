...
[**ClassList**](annotated.md) **>** [**tinyxml2**](namespacetinyxml2.md) **>** [**XMLUnknown**](classtinyxml2_1_1_x_m_l_unknown.md)
...
| virtual XMLUnknown \* | [**ToUnknown**](#function-tounknown-12) () override<br>_Safely cast to an Unknown, or null._  |
| virtual const XMLUnknown \* | [**ToUnknown**](#function-tounknown-22) () override const<br> |
...
|   | [**XMLUnknown**](#function-xmlunknown-12) (XMLDocument \* doc) <br> |
| virtual  | [**~XMLUnknown**](#function-xmlunknown) () <br> |
...
An example of using [**Accept()**](classtinyxml2_1_1_x_m_l_unknown.md#function-accept):  
...
```C++
virtual XMLNode * tinyxml2::XMLUnknown::ShallowClone (
...
```C++
virtual bool tinyxml2::XMLUnknown::ShallowEqual (
...
```C++
inline virtual XMLUnknown * tinyxml2::XMLUnknown::ToUnknown () override
```



Implements [*tinyxml2::XMLNode::ToUnknown*](classtinyxml2_1_1_x_m_l_node.md#function-tounknown-12)
...
```C++
inline virtual const XMLUnknown * tinyxml2::XMLUnknown::ToUnknown () override const
```



Implements [*tinyxml2::XMLNode::ToUnknown*](classtinyxml2_1_1_x_m_l_node.md#function-tounknown-22)
...
```C++
virtual char * tinyxml2::XMLUnknown::ParseDeep (
    char * p,
...
### function XMLUnknown [1/2]

```C++
explicit tinyxml2::XMLUnknown::XMLUnknown (
    XMLDocument * doc
) 
```
