...
[**ClassList**](annotated.md) **>** [**tinyxml2**](namespacetinyxml2.md) **>** [**XMLDeclaration**](classtinyxml2_1_1_x_m_l_declaration.md)
...
| virtual XMLDeclaration \* | [**ToDeclaration**](#function-todeclaration-12) () override<br>_Safely cast to a Declaration, or null._  |
| virtual const XMLDeclaration \* | [**ToDeclaration**](#function-todeclaration-22) () override const<br> |
...
|   | [**XMLDeclaration**](#function-xmldeclaration-12) (XMLDocument \* doc) <br> |
| virtual  | [**~XMLDeclaration**](#function-xmldeclaration) () <br> |
...
An example of using [**Accept()**](classtinyxml2_1_1_x_m_l_declaration.md#function-accept):  
...
```C++
virtual XMLNode * tinyxml2::XMLDeclaration::ShallowClone (
...
```C++
virtual bool tinyxml2::XMLDeclaration::ShallowEqual (
...
```C++
inline virtual XMLDeclaration * tinyxml2::XMLDeclaration::ToDeclaration () override
```



Implements [*tinyxml2::XMLNode::ToDeclaration*](classtinyxml2_1_1_x_m_l_node.md#function-todeclaration-12)
...
```C++
inline virtual const XMLDeclaration * tinyxml2::XMLDeclaration::ToDeclaration () override const
```



Implements [*tinyxml2::XMLNode::ToDeclaration*](classtinyxml2_1_1_x_m_l_node.md#function-todeclaration-22)
...
```C++
virtual char * tinyxml2::XMLDeclaration::ParseDeep (
    char * p,
...
### function XMLDeclaration [1/2]

```C++
explicit tinyxml2::XMLDeclaration::XMLDeclaration (
    XMLDocument * doc
) 
```
