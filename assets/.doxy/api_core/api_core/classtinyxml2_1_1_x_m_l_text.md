...
[**ClassList**](annotated.md) **>** [**tinyxml2**](namespacetinyxml2.md) **>** [**XMLText**](classtinyxml2_1_1_x_m_l_text.md)
...
|  bool | [**CData**](#function-cdata) () const<br>_Returns true if this is a CDATA text element._  |
|  void | [**SetCData**](#function-setcdata) (bool isCData) <br>_Declare whether this should be CDATA or standard text._  |
...
| virtual XMLText \* | [**ToText**](#function-totext-12) () override<br>_Safely cast to Text, or null._  |
| virtual const XMLText \* | [**ToText**](#function-totext-22) () override const<br> |
...
|   | [**XMLText**](#function-xmltext-12) (XMLDocument \* doc) <br> |
| virtual  | [**~XMLText**](#function-xmltext) () <br> |
...
A text node can have 2 ways to output the next. "normal" output and CDATA. It will default to the mode it was parsed from the XML file and you generally want to leave it alone, but you can change the output mode with [**SetCData()**](classtinyxml2_1_1_x_m_l_text.md#function-setcdata) and query it with [**CData()**](classtinyxml2_1_1_x_m_l_text.md#function-cdata). 
...
```C++
virtual bool tinyxml2::XMLText::Accept (
    XMLVisitor * visitor
) override const
```
...
An example of using [**Accept()**](classtinyxml2_1_1_x_m_l_text.md#function-accept):  
...
_Returns true if this is a CDATA text element._ 
```C++
inline bool tinyxml2::XMLText::CData () const
```
...
_Declare whether this should be CDATA or standard text._ 
```C++
inline void tinyxml2::XMLText::SetCData (
    bool isCData
) 
```
...
```C++
virtual XMLNode * tinyxml2::XMLText::ShallowClone (
...
```C++
virtual bool tinyxml2::XMLText::ShallowEqual (
...
```C++
inline virtual XMLText * tinyxml2::XMLText::ToText () override
```



Implements [*tinyxml2::XMLNode::ToText*](classtinyxml2_1_1_x_m_l_node.md#function-totext-12)
...
```C++
inline virtual const XMLText * tinyxml2::XMLText::ToText () override const
```



Implements [*tinyxml2::XMLNode::ToText*](classtinyxml2_1_1_x_m_l_node.md#function-totext-22)
...
```C++
virtual char * tinyxml2::XMLText::ParseDeep (
    char * p,
...
### function XMLText [1/2]

```C++
inline explicit tinyxml2::XMLText::XMLText (
    XMLDocument * doc
) 
```
...
```C++
inline virtual tinyxml2::XMLText::~XMLText () 
```
