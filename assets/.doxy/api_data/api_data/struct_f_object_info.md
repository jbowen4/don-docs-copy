...
| Type | Name |
| ---: | :--- |
|  [**FObjectInfo**](struct_f_object_info.md) | [**ORIGIN**](#variable-origin)   = `[**FObjectInfo**](struct_f_object_info.md)()`<br> |
...
| Type | Name |
| ---: | :--- |
|   | [**FObjectInfo**](#function-fobjectinfo-14) (const ObjID & Name, const bool Visibility, const TOptRef&lt; const [**FObjectInfo**](struct_f_object_info.md) &gt; & ParentIn, const FVector & Position, const FQuat & Orientation) <br> |
...
|  FORCEINLINE const TOptRef&lt; const [**FObjectInfo**](struct_f_object_info.md) &gt; & | [**GetParent**](#function-getparent) () const<br> |
...
|   | [**\_WITH**](#function-_with-35) (TOptRef&lt; const [**FObjectInfo**](struct_f_object_info.md) &gt;, Parent) <br> |
...
| Type | Name |
| ---: | :--- |
|  FORCEINLINE void | [**SetParentRef**](#function-setparentref) (TOptRef&lt; const [**FObjectInfo**](struct_f_object_info.md) &gt; NewParent) <br> |
